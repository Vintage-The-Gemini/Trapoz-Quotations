  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-bold text-primary">Record New LPO</h1>
      </div>
      ...
      {error ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-blue-900/30 border border-blue-700 text-blue-200 p-4 rounded-lg flex items-start">
            ...
            <p className="text-sm">
              Use this form to record Local Purchase Orders (LPOs) received from
              clients. You can link it to an approved quotation or create a
              standalone LPO.
            </p>
          </div>
          ...
          <div className="bg-dark-light rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div
                  className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-dark-lighter border-dashed rounded-md"
                  ...
                  {!uploadedFile ? (
                    <div className="space-y-1 text-center">
                      ...
                      <div className="flex text-sm text-gray-400">
                        <label
                          htmlFor="file-upload"
                          className="relative cursor-pointer bg-dark-lighter rounded-md font-medium text-primary hover:text-primary-light px-3 py-2"
                        >
          ...
          <div className="bg-dark-light rounded-lg p-6">
            ...
            <div className="mb-6">
              ...
              <p className="text-xs text-gray-500 mt-1">
                {selectedQuotation
                  ? "Client details are populated from the selected quotation"
                  : "Selecting a client will auto-fill the details below"}
              </p>
            </div>
                  ...
                  {formData.items.length === 0 ? (
                    <tr>
                      ...
                      >
                        No items added yet.{" "}
                        {selectedQuotation
                          ? "Items should be loaded from the quotation."
                          : 'Click "Add Item" to add items to this LPO.'}
                      </td>
                    </tr>
                  ) : (
                ...
                {formData.items.length > 0 && (
                  <tfoot>
                    <tr>
                      <td
                        colSpan="4"
                        className="text-right py-3 px-4 font-medium text-gray-400"
                      >
                        Subtotal
                      </td>
